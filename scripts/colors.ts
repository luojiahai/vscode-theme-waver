...
export const WaverThemes = {
  ...
  string: [orange.get("5d").hex(), orange.get("7d").hex()],
  variable: [lightblue.get("5dd").hex(), lightblue.get("7d").hex()],
  keyword: [pink.get("5d").hex(), pink.get("7d").hex()],
  number: [lightgreen.get("5dd").hex(), lightgreen.get("7d").hex()],
  boolean: [cyan.get("5d").hex(), cyan.get("7d").hex()],
  operator: [orange.get("5d").hex(), orange.get("7d").hex()],
  function: [lightyellow.get("5dd").hex(), lightyellow.get("7d").hex()],
  constant: [lightgreen.get("5dd").hex(), lightgreen.get("7d").hex()],
  class: [green.get("5dd").hex(), green.get("7d").hex()],
  interface: [green.get("5dd").hex(), green.get("7d").hex()],
  type: [green.get("5dd").hex(), green.get("7d").hex()],
  builtin: [blue.get("5d").hex(), blue.get("7d").hex()],
  property: [pink.get("5d").hex(), pink.get("7d").hex()],
  namespace: [pink.get("5d").hex(), pink.get("7d").hex()],
  punctuation: [gray.get("5d").hex(), gray.get("7d").hex()],
